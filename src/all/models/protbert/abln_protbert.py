...
with tf.device('/gpu:0'):
    ...
    # callbacks
    mcp_save = keras.callbacks.ModelCheckpoint('saved_models/abln_protbert.h5', save_best_only=True, monitor='val_accuracy', verbose=1)
    ...
    model = load_model('saved_models/abln_protbert.h5', custom_objects={'sensitivity':sensitivity})
...
with tf.device('/cpu:0'):
    ...
    df.to_csv('ABLN_CNN_ProtBert.csv')
...
F1 Score:  0.8209729552135488
Acc Score:  0.8435131520285332
MCC:  0.8428505645306651
Bal Acc:  0.7185391741339109
'''